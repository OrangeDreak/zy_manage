<template>
  <basic-container>
    ...
    <el-dialog title="角色配置" :visible.sync="box" width="345px">
  ...
  methods: {
    ...
    handleRole() {
      if (this.selectionList.length !== 1) {
        this.$message.warning(this.selectionList.length ? "只能选择一条数据" : "请选择一条数据");
        return;
      }
      this.menuTreeObj = [];
      ...
      grantTree().then((res) => {
        ...
        console.log(this.dataScopeGrantList);
        ...
        getRole(this.ids).then((res) => {
          ...
          console.log(this.menuTreeObj);
          console.log(this.dataScopeTreeObj);
        });
      });
    },
    handleDelete() {
